...
def objective(trial):
    ...
    optimizer = torch.optim.Adam(gruanfis.parameters(), lr=params['lr'])
...
df_trials.to_csv("bigruanfis_daily_optuna.csv", index=False)