...
def objective(trial):
    params = {
        ...
        'activation': trial.suggest_categorical('activation', ['relu', 'identity', 'sigmoid']),
        'lr': trial.suggest_float('lr', 1e-4, 1e-2, log=True),
        'seq_length': trial.suggest_int('seq_length', 8, 20),
...
df_trials.to_csv("lstm_optuna.csv", index=False)